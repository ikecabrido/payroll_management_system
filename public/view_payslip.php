...
<body>
    <!-- <div class="card-header">
        <a href="" onclick="window.history.back()" class="btn btn-tool">
            <i class="fas fa-arrow-left"></i>
        </a>
    </div> -->

    <button class="bck-btn" onclick="window.history.back()"><i class="fas fa-arrow-left"></i> Back</button>
    ...
    <div class="payslip">
        ...
        <p>
            ...
            <strong>Type:</strong> <?= htmlspecialchars($payslip['employment_type']) ?><br>
        ...
        <button onclick="window.location.href='../public/print_payslip.php?id=<?= $payslipId ?>'" class="btn btn-primary btn-print">Print Payslip</button>
    </div>
</body>
